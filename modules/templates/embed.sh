...
python3 /home/cmcwhite/vcmsa/src/vcmsa/vcmsa_embed.py  -m ${model} -f ${seqs} -o ${id}.pkl --heads ${heads} --get_sequence_embeddings --get_aa_embeddings --padding $padding
elif [ "$heads" = false ] ; then

echo "Selecting layers"
    python3 /home/cmcwhite/vcmsa/src/vcmsa/vcmsa_embed.py -m ${model} -f ${seqs} -o ${id}.pkl --layers ${layers} --get_sequence_embeddings --get_aa_embeddings --padding $padding
